...
\begin{document}
    ...
    \section{Documented Design}
        ...
        \subsection{Maze Generation}
            ...
            \clearpage
            \begin{figure}[hbt!]
                \centerline{\includegraphics[scale=0.25, viewport=10 4868 2226 7668, clip=true]{img/Design/Maze Gen Prototype.png}}
            \end{figure}
            \clearpage
            \begin{figure}[hbt!]
                \centerline{\includegraphics[scale=0.25, viewport=10 2068 2226 4868, clip=true]{img/Design/Maze Gen Prototype.png}}
            \end{figure}
            \clearpage
            \begin{figure}[hbt!]
                \centerline{\includegraphics[scale=0.25, viewport=10 0 2226 2068, clip=true]{img/Design/Maze Gen Prototype.png}}
            \end{figure}
            \clearpage
            \begin{multicols*}{3}
                [
