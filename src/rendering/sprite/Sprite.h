...
{
  public:
	// Data type that holds all the different ids for all the sprites in the game
	enum ID
	{
		errorID = -1,
...
// Operations for the sprite id so that they can easily work with integers
...
// More definitions for the starting of a group of textures
